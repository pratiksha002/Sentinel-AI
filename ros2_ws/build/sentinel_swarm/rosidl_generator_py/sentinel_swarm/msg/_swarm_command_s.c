...
bool sentinel_swarm__msg__swarm_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentinel_swarm.msg._swarm_command.SwarmCommand", full_classname_dest, 46) == 0);
  }
  sentinel_swarm__msg__SwarmCommand * ros_message = _ros_message;
  {  // command_id
  ...
  {  // formation_scale
    PyObject * field = PyObject_GetAttrString(_pymsg, "formation_scale");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->formation_scale = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // mission_timeout
    PyObject * field = PyObject_GetAttrString(_pymsg, "mission_timeout");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->mission_timeout = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * sentinel_swarm__msg__swarm_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentinel_swarm.msg._swarm_command");
  ...
  {  // formation_scale
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->formation_scale);
    {
      int rc = PyObject_SetAttrString(_pymessage, "formation_scale", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // mission_timeout
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->mission_timeout);
    {
      int rc = PyObject_SetAttrString(_pymessage, "mission_timeout", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
