...
#include "sentinel_swarm/msg/detail/formation_reference__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: reference_positions
  {
    ...
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.reference_positions[i],
        cdr);
    }
  }
  // Member: reference_velocities
  {
    ...
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.reference_velocities[i],
        cdr);
    }
  }
  ...
  sentinel_swarm::msg::FormationReference & ros_message)
{
  ...
  // Member: reference_positions
  {
    ...
    ros_message.reference_positions.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.reference_positions[i]);
    }
  }
  ...
  // Member: reference_velocities
  {
    ...
    ros_message.reference_velocities.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.reference_velocities[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: drone_ids
  {
    ...
    size_t item_size = sizeof(ros_message.drone_ids[0]);
  ...
  // Member: reference_positions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.reference_positions[index], current_alignment);
    }
  }
  // Member: reference_velocities
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.reference_velocities[index], current_alignment);
    }
  }
  // Member: formation_error
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_swarm::msg::FormationReference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentinel_swarm::msg::FormationReference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_swarm::msg::FormationReference *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FormationReference__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sentinel_swarm::msg::FormationReference *>(
...
static size_t _FormationReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FormationReference(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FormationReference__callbacks = {
  "sentinel_swarm::msg",
  "FormationReference",
...
static rosidl_message_type_support_t _FormationReference__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FormationReference__callbacks,
...
{
  return &sentinel_swarm::msg::typesupport_fastrtps_cpp::_FormationReference__handle;
}
