...
#include "sentinel_swarm/msg/detail/swarm_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentinel_swarm::msg::SwarmCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentinel_swarm::msg::SwarmCommand & ros_message)
{
  // Member: command_id
  cdr >> ros_message.command_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_swarm::msg::SwarmCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentinel_swarm::msg::SwarmCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_swarm::msg::SwarmCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SwarmCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sentinel_swarm::msg::SwarmCommand *>(
...
static size_t _SwarmCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SwarmCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SwarmCommand__callbacks = {
  "sentinel_swarm::msg",
  "SwarmCommand",
...
static rosidl_message_type_support_t _SwarmCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SwarmCommand__callbacks,
...
{
  return &sentinel_swarm::msg::typesupport_fastrtps_cpp::_SwarmCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentinel_swarm, msg, SwarmCommand)() {
  return &sentinel_swarm::msg::typesupport_fastrtps_cpp::_SwarmCommand__handle;
}
